...
- D1 separate skill (not a pipeline mode) · D2 structure-preserving default + redesign mode ·
  ...
  D7 branched off graphify (1.12.0) → 1.13.0.
...
- Registration: `skills/README.md`, `README.md`, `AGENTS.md` task router, `CHANGELOG.md` 1.13.0.
- Version 1.12.0 → 1.13.0 across all four manifests (VERSION, package.json, plugin.json,
