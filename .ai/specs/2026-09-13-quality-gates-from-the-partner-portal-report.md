...
| G29 | (P6, 2026-09-13, po zamknięciu prac na gałęzi) **Merge 1.34.0 na `main` teraz, bez F5**, „żeby wszyscy mogli pracować na tym i zbierać feedback”. Zastępuje F5 i G15. Skutek przyjęty: oszczędność 1.33.x będzie mierzona razem z 1.34.0. `CUTOFF` = 2026-09-13 | upgrade klienta i czekanie na F5; upgrade plus zbadanie odmowy zapisu raportu |
