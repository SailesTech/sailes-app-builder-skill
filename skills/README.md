...
| **sailes-design** | The frontend/visual design phase. Deliberate direction (palette/type/layout/**signature**) + anti-AI-default check + a11y/interaction discipline + a **premium-craft finish** (expensive-looking, not just correct) → persisted design artifact. | `SKILL.md`, `design-judgment.md`, `ux-rules.md`, `premium-craft.md` |
